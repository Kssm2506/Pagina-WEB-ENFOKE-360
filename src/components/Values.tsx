...
export function Values() {
  ...
  return <section ref={containerRef} className="sevora-benefits relative overflow-hidden py-20 md:py-[84px]">
    <div className="relative z-10 mx-auto max-w-[1152px] px-6"><div className="mx-auto mb-16 max-w-[900px] text-center"><div className="mb-4 inline-flex items-center rounded-full border border-[#dedfe2] bg-white/40 px-3 py-1"><span className="text-sm text-[#24242a]">Beneficios</span></div><h2 className="text-[42px] font-medium leading-[1.1] tracking-[-0.05em] text-[#121218] md:text-[58px]">Descubrí por qué hacemos la diferencia</h2><p className="mx-auto mt-5 max-w-[650px] text-[18px] font-normal leading-[27px] text-[#5e5f68] md:text-[20px] md:leading-[30px]">Combinamos estrategia, diseño y performance para transformar tu presencia digital en crecimiento real.</p></div>
