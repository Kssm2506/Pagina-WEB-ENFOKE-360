...
export function DisenoWebHero() {
  ...
  return (
    <section className="relative pt-[80px] pb-[20px] md:pt-[140px] md:pb-[60px] overflow-hidden bg-[#0b0b0d] rounded-b-[60px] md:rounded-b-[120px] z-20 shadow-2xl">
      ...
      <div className="max-w-[1100px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-1">
            <div className="inline-flex items-center px-3 py-0.5 rounded-full border border-white/10 mb-5">
              <span className="text-xs font-light tracking-normal text-white">Agencia de diseño web profesional</span>
            </div>
            
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white mb-6 leading-tight">
